...
$areaInGaj = formatIndianNumber($property['areaInGaj']);
...
<?php
$pageTitle = "Admin Dashboard - View Buy Property";
        ...
        <div class="container py-4">
            ...
            <div class="card shadow border-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4"><strong>Name:</strong> <?= htmlspecialchars($property['name']) ?></div>
                        <div class="col-md-4"><strong>Mobile:</strong> <a href="tel:<?= htmlspecialchars($property['mobile']) ?>"><?= htmlspecialchars($property['mobile']) ?></a></div>
                        <div class="col-md-4"><strong>Email:</strong> <a href="mailto:<?= htmlspecialchars($property['email']) ?>"><?= htmlspecialchars($property['email']) ?></a></div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4"><strong>Location:</strong> <?= htmlspecialchars($property['locality2']) ?></div>
                        <div class="col-md-4"><strong>Message:</strong>
                ...
                <div class="col-12">
                    ...
                    <div class="card shadow border-danger">
                        ...
                        <div class="card-body p-0">
                                            ...
                                            <?php foreach ($listData as $index => $row): ?>
                                                <tr>
                                                    ...
                                                    <td class="d-flex flex-column flex-md-row gap-1">
                                                        <a href="view_buy_property_suggestion.php?sid=<?= $row['id'] ?>&bid=<?= $propertyId ?>" class="btn btn-sm btn-danger">View</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php else: ?>
                            ...
                            <?php
                            // Get current filters (exclude 'page' to update it separately)
                            $currentFilters = $_GET;
