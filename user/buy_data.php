...
$totalRows = countBuyPropertyForAUser($userId);
$totalPages = ceil($totalRows / $limit);

$purchaseData = listPurchasePropertyForAUser($userId, $limit, $offset);

?>

<?php
$pageTitle = "User Dashboard - Buy Data";
                ...
                <div class="col-12">
                    ...
                    <div class="card shadow border-primary">
                        <div class="card-header bg-primary text-white text-center">
                            <h5 class="mb-0">My Buy Requests</h5>
                        </div>
