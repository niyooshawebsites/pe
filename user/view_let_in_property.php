...
<?php
$pageTitle = "User Dashboard - View let in Property";
...
<body class="d-flex flex-column min-vh-100 app-background">
    ...
    <main class="flex-fill py-4">
        <div class="container">
            <a href="all_rented_properties.php" class="btn btn-outline-light mb-3">&larr; Back</a>
            ...
            <div class="card shadow border-success">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4 mb-2">
                            <strong>Mobile:</strong> <?= htmlspecialchars($property['mobile']) ?>
                        </div>
                        <div class="col-md-4 mb-2">
