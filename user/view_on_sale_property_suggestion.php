...
<body class="d-flex flex-column min-vh-100 app-background">
    ...
    <main class="flex-fill py-4">
        <div class="container">
            <a href="view_buy_property.php?id=<?= $buyerId ?>" class="btn btn-outline-light mb-3">&larr; Back</a>
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-12 col-md-6 mb-2">
                            <strong>Area:</strong> <?= htmlspecialchars($property['typeOfProperty']) ?>
                        </div>
                        <div class="col-12 col-md-6 mb-2">
